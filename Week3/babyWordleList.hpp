/*******
 * This file contains a small fraction of the wordle words...I'd use them all, but then my program would crash :(
 *******/
...
const int wordleLength = 2315;
const std::string wordleList[] = {"aback", // contains "all" the wordle words
"abase",
"abate",
"abbey",
"abbot",
